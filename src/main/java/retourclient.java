 ...
 */
public class retourclient extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String jpql = "SELECT c.nom, c.prenom, v.marque, v.modele, v.annee, r.DateDebut, r.DateFin " +
                          ...
                          "WHERE r.client = c AND r.voiture = v AND v.disponibilite = 'disponible'";
            ...
            request.getRequestDispatcher("retourclient.jsp").forward(request, response);
