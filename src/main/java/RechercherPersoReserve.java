...
public class RechercherPersoReserve extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	  ...
    	  EntityManager entityManager = emf.createEntityManager();
    	        ...
    	        TypedQuery<Voiture> query = entityManager.createQuery(
    	                "SELECT v FROM Voiture v WHERE v.marque = :marque AND v.disponibilite =:disponibilite", Voiture.class);

    	        query.setParameter("marque", marque);
    	        query.setParameter("disponibilite", "non disponible");
    	        ...
    	        request.getRequestDispatcher("rechercherpersoNondispo.jsp").forward(request, response);
    }
}
