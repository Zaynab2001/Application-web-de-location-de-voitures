...
<br>
    <div class="container">
        <div class="left-column">
            <p style="font-size: 60px; font-style: italic; color: white;"></p>
        </div>
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <h1 class="mb-4">Reçu de réservation</h1>
                    </div>
                </div>
                ...
                <div class="text-center mt-4">
                    ...
                    <input type="submit" class="btn btn-success" formaction="paymentform.jsp" value="Payer">
                </div>
            </div>
        </div>
    </div>
